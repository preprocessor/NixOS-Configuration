{
  w.desktop =
    ...
    {
      custom.programs.hyprland.lua.files."permissions".content = /* lua */ ''
        hl.config({
        ...
        hl.permission({ binary = "${lib.getExe config.custom.programs.vesktop.package}", type = "screencopy", mode = "allow" })
