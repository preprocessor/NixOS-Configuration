{
  flake.modules.homeManager.desktop =
    ...
    #     owner = "F0XX00";
    #     repo = "midnight-everforest-discord";
    #     rev = "501e9fef6e208cffc4ea68f0c292976d28230fed";
    #     hash = "sha256-GGm4xhnSPyuCpAB31QWAdxN8deW89OC6DkdLG4o/Njo=";
    #   };
    #
    #   theme = {
    #     name = "Everforest";
    #     file = "${repo}/midnight-everforest.theme.css";
    #   };
    # in
    {
      programs.vesktop = {
