{
  flake.modules.nixos.desktop.custom.programs.niri.settings = {
    binds = {
      ...
      "Mod+Ctrl+Left".move-window-to-monitor-left = null;
      "Mod+Ctrl+Down".move-window-to-monitor-down = null;
      "Mod+Ctrl+Up".move-window-to-monitor-up = null;
      "Mod+Ctrl+Right".move-window-to-monitor-right = null;
      ...
      "Mod+Backslash".toggle-window-floating = null;
      "Mod+Shift+Backslash".switch-focus-between-floating-and-tiling = null;
